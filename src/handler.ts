 ...
 */
export class VariableInspectionHandler implements IDisposable, VariableInspector.IInspectable {
     ...
     */
    get inspected(): ISignal<VariableInspectionHandler, VariableInspector.IVariableInspectorUpdate> {
    ...
    private _inspected = new Signal<this, VariableInspector.IVariableInspectorUpdate>(this);
